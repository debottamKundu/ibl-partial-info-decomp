...
def run_decompositon_glm_hmm(one, session_id, spikes, clusters, list_of_regions, normalization='neuron'):
...
if __name__=='__main__':
    ...
    list_of_eids = np.load('D:\\personal\\phD\\code\\information-decomposition\\ibl-partial-info-decomp\\data\\processed\\eids_with_detailed_insertions.npy',allow_pickle=True)
